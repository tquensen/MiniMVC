...
class MiniMVC_Db
{
    ...
    public function init()
    {
        ...
        $cacheDriver = new Doctrine_Cache_Db(array('connection' => $cacheConn, 'tableName' => 'MiniMVC_cache'));
        ...
        $this->connection->setAttribute(Doctrine::ATTR_QUERY_CACHE, $cacheDriver);
